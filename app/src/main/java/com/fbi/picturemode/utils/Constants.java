...
public class Constants {
  ...
  public static final int CODE_PICTURE_DOWNLOAD_ALREADY = 0;
  public static final int CODE_PICTURE_DOWNLOAD_SUCCESS = 1;
  public static final int CODE_PICTURE_DOWNLOAD_FAIL = 2;
